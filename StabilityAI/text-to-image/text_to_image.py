...
def text_to_image(api_host, api_key, engine_id, height, width, prompt, \
 weight, cfg_scale, clip_guidance_preset, sampler, seed, steps, style_preset):
    ...
    for i, image in enumerate(data["artifacts"]):
        decoded_image = io.BytesIO(base64.b64decode(image["base64"]))
...
engine_id = tab2.selectbox(
    'Engine ID',
    ('stable-diffusion-v1-5','stable-diffusion-xl-1024-v0-9','stable-diffusion-xl-1024-v1-0','stable-diffusion-v1', 'stable-diffusion-v1-5', 'stable-diffusion-512-v2-0',
